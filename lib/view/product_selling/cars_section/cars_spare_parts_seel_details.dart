...
class CarsSparePartsSellDetails extends ConsumerWidget {
  const CarsSparePartsSellDetails({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Text('Category: Cars Spare Part Type'),
          Row(
                ...
                child: ElevatedButton(
                    onPressed: () async {
                      if (productTitle.isEmpty ||
                        ...
                        CarsSparePartsModel carsSparePartsSellDetailsModel =
                            CarsSparePartsModel(
                        ...
                        await firestoreService.uploadProductData(
                          ...
                          productData: carsSparePartsSellDetailsModel.toMap(),
                        );
                      }
                    },
