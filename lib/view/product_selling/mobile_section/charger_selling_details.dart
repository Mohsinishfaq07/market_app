    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Consumer(
            builder: (_, WidgetRef ref, __) {
              ...
              return CustomDropdown(
                ...
                selectedValue: selectedDeviceType.toString(),
              );
            },
          ),
          const Text('Type'),
          Consumer(
            builder: (_, WidgetRef ref, __) {
              final selectedChargerType =
                  ref.watch(productSellProvider.chargerType);
              return CustomDropdown(
                items: [
                  'Select',
                  'IOS',
                ...
                selectedValue: selectedChargerType.toString(),
              );
            },
          ),
