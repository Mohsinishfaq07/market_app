...
import 'package:market/models/selling_models/watch_model.dart';
          ...
          Consumer(
            builder: (_, WidgetRef ref, __) {
              ...
              return CustomDropdown(
                items: ['Select', 'Apple', 'Samsung', 'Mi', 'Huawei', 'Others'],
                onChanged: (val) {
                  if (val != null) {
                ...
                child: ElevatedButton(
                    onPressed: () async {
                      if (productBrand.isEmpty ||
                        ...
                        WatchSellModel watchSellModel = WatchSellModel(
                        ...
                        await firestoreService.uploadProductData(
                          ...
                          productData: watchSellModel.toMap(),
                        );
                      }
                    },
